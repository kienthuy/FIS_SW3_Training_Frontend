...
export class AppDashboardComponent {
  ...
  lateColums: string[] = ['profile','checkinTime','late'];
  listLate = [
    {
      fullname: "Phạm Trương Kiến Thụy",
      imagePath: "assets/images/profile/user-1.jpg",
      position: "Cán bộ lập trình",
      startDate: "2024-06-08T10:00:00Z",
      endDate: "2024-06-08T12:00:00Z",
      status: "LATE"
    }
  ]
  

  earlyColums: string[] = ['profile','checkOutTime','early'];
  listEarly = [
    {
      fullname: "Huỳnh Thị Thùy Trang",
      imagePath: "assets/images/profile/user-2.jpg",
      position: "Cán bộ kiểm thử",
      startDate: "2024-06-08T10:00:00Z",
      endDate: "2024-06-08T12:00:00Z",
      status: "EARLY"
    }
  ...
  historyColumns: string[] = ['fullname', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'];
  listHistory = [
    {
      userId: 'THUYNPK2',
      fullname: 'Phạm Trương Kiến Thụy',
      imagePath: "assets/images/profile/user-1.jpg",
      timer: {
        T2: { checkin: '08:00', checkout: '17:00' },
        T3: { checkin: '08:15', checkout: '17:10' },
        T4: { checkin: '08:10', checkout: '17:05' },
        T5: { checkin: '08:00', checkout: '17:00' },
        T6: { checkin: '08:05', checkout: '17:15' },
        T7: { checkin: null, checkout: null },
        CN: { checkin: null, checkout: null }
      }
    },
    {
      userId: 'TrangHTT36',
      ...
      timer: {
        T2: { checkin: '08:00', checkout: '17:00' },
        T3: { checkin: '08:00', checkout: '17:00' },
        T4: { checkin: '08:00', checkout: '17:00' },
        T5: { checkin: '08:00', checkout: '17:00' },
        T6: { checkin: '08:00', checkout: '17:00' },
        T7: { checkin: null, checkout: null },
        CN: { checkin: null, checkout: null }
      }
    }
  ...
  constructor() {
    ...
    this.trafficChart = {
      series: [48, 30, 12, 10],
      labels: ['Checkin', 'Không Checkin', 'Đi muộn', 'Về sớm'],
      chart: {
        type: 'donut',
